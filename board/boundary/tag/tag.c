...
#define GP_PTF21	GPIO_NR(F, 21)
	...
	IMX8ULP_PAD_PTC1__PTC1 | MUX_PAD_CTRL(PAD_CTL_PUS_UP),
	IMX8ULP_PAD_PTC2__PTC2 | MUX_PAD_CTRL(PAD_CTL_PUS_UP),
	IMX8ULP_PAD_PTC3__PTC3 | MUX_PAD_CTRL(PAD_CTL_PUS_DOWN),
	IMX8ULP_PAD_PTC4__PTC4 | MUX_PAD_CTRL(PAD_CTL_PUS_UP),
...
#define GP_BACKLIGHT_EN		GPIO_NR(E, 9)
	...
	IMX8ULP_PAD_PTF17__PTF17 | MUX_PAD_CTRL(PAD_CTL_PUS_UP),
